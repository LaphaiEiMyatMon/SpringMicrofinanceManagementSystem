    ...
    $.validationEngineLanguage = {
        newLang: function () {
            $.validationEngineLanguage.allRules = {
                ...
                "groupRequired": {
                    "regex": "none",
                    "alertText": "*  ID又はメールアドレスどちらかを入力ください"
                },
                "maxSize": {
                    "regex": "none",
                    "alertText": "* ",
                ...
                "date": {
                    ...
                    "alertText": "",
                    "alertText1": "* 日付は半角で DD/MM/YYYY の形式で入力してください",
                    "alertText2": "* 日付を正しく入力してください",
                    "func": function (field, rules, i, options) {
                        if (field.val() == "") {
                            return true;
                        }
                ...
                "yearMonth": {
                    ...
                    "alertText": "",
                    "alertText1": "* 年月は半角で YYYY/MM の形式で入力してください",
                    "alertText2": "* 年月を正しく入力してください",
                    "func": function (field, rules, i, options) {
                        if (field.val() == "") {
                            return true;
                        }
                ...
                "Monthyear": {
                    //"regex": /^\d{4}[\/](0?[1-9]|1[012])$/,
                    "alertText": "",
                    "alertText1": "* 年月は半角で MM/YYYY の形式で入力してください",
                    "alertText2": "* 年月を正しく入力してください",
                    "func": function (field, rules, i, options) {
                        if (field.val() === "") {
                            return true;
